...
from ..models import MeditationSession, UserInfo, Meditation, MeditationGrade, MeditationTheme
...
class MeditationService:
    ...
    @staticmethod
    def end_meditation_session(meditation_session: MeditationSession) -> MeditationSession | None:
        return MeditationRepository.end_meditation_session(meditation_session=meditation_session)
    ...
    @staticmethod
    def get_meditations_by_meditation_theme(meditation_theme: MeditationTheme) -> List[Meditation]:
        return MeditationRepository.get_meditations_by_meditation_theme(meditation_theme=meditation_theme)
